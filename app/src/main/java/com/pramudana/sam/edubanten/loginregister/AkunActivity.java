...
public class AkunActivity extends MyFuction {
...
//    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_akun);
                    ...
                    user.updateEmail(nE).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (!task.isSuccessful()){
                                ...
                                Toast.makeText(AkunActivity.this, "berhasil gantil email", Toast.LENGTH_SHORT).show();
                                verifikasiemail();
            ...
            case R.id.changePass:
                ...
                if (user!=null&&!nP.equals("")) {
                        user.updatePassword(nP).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (!task.isSuccessful()) {
                                    Toast.makeText(AkunActivity.this, "gagal :" + task.getException(), Toast.LENGTH_SHORT).show();
                                } else {
                                    Toast.makeText(AkunActivity.this, "berhasil update/ganti password", Toast.LENGTH_SHORT).show();
            ...
            case R.id.send:
                ...
                if (user!=null&&!om.equals("")){
                    auth.sendPasswordResetEmail(om).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(!task.isSuccessful()){
                                Toast.makeText(AkunActivity.this, "gagal ganti email"+task.getException(), Toast.LENGTH_SHORT).show();
                            }else{
                                Toast.makeText(AkunActivity.this, "berhasil ganti email", Toast.LENGTH_SHORT).show();
                                auth.signOut();
     //                           startActivity(new Intent(AkunActivity.this,LoginActivity.class));
                                finish();
                            }
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (user!=null){
                            user.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (!task.isSuccessful()){
                                        Toast.makeText(AkunActivity.this, "gagal hapus akun"+task.getException(), Toast.LENGTH_SHORT).show();
                                    }else {
                                        Toast.makeText(AkunActivity.this, "profile akun anda berhasil di hapus!", Toast.LENGTH_SHORT).show();
                                        startActivity(new Intent(AkunActivity.this,LoginActivity.class));
                                        finish();
                                    }
                                    progressBar.setVisibility(View.GONE);
            ...
            case R.id.sign_out:
                ...
                builder1.setMessage("yakin");
                builder1.setIcon(R.drawable.edu_banten_icon);
